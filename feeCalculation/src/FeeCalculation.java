...
public class FeeCalculation {
    ...
    public static void main(String[] args) {
        ...
        now.set(GregorianCalendar.HOUR_OF_DAY, 3);
        now.set(GregorianCalendar.MINUTE,20);
        
        then.set(GregorianCalendar.HOUR_OF_DAY, 22);
        then.set(GregorianCalendar.MINUTE,0);
        System.out.println("Estimated fee:  " + calculateFee(now, then));

    }
    
    private static int calculateFee(GregorianCalendar start, GregorianCalendar end){
